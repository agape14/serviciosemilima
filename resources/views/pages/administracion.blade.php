...
<main class="main">
    ...
    <section id="section-subasta">
        ...
        <div>    
            ...
            <img src="images/services/icon4.png" alt="Ícono 4" width="100" height="100">
            <h4>ADMINISTRACIÓN DE</h4>
            <h2 class="line-texto">PATRIMONIO INMOBILIARIO</h2>
          <h6></h6>
          <h4>¡RENTABILIZA CORRECTAMENTE TU INMUEBLE!</h4>
    ...
    <div class="container-subasta">
        ...
        <div class="column image-section">
            <p>Administramos tu patrimonio inmobiliario para maximizar su valor y la rentabilidad, a través de su gestión y supervisión, administración de alquileres, gestión financiera, asesoramiento legal, la planificación y estrategia para optimizar</p>
            <ul class="lista-con-puntos">
              <li>Servicio de <span>Elaboración de Directivas</span>para administración de bienes inmuebles del Margesí inmobiliario.</li>
              <li>Servicio de <span>Elaboración de Margesí Inmobiliario</span>(inspecciones de predios de propiedad de terceros, a fin de elaborar el margesí).</li>
            </ul>
            <img src="images/subasta/img/img administracion.png" alt="Imagen de subasta">
        </div>
